...
public class TwentyNodesFullyConnected {
    public static void main(String[] args) {
        ...
        for (int i=0;i<19;i++){
            for (int j = i+1;j<20;j++){
                if (i!=j){
                    list1.get(i).addNeighbor(list1.get(j),rand.nextInt(upperbound));
                }
            }
        }
        ...
        for (int i=0;i<19;i++){
            for (int j = i+1;j<20;j++){
                if (i!=j){
                    list2.get(i).addNeighbor(list2.get(j),rand.nextInt(upperbound));
                }
            }
        }
        ...
        for (int i=0;i<19;i++){
            for (int j = i+1;j<20;j++){
                if (i!=j){
                    list3.get(i).addNeighbor(list3.get(j),rand.nextInt(upperbound));
                }
            }
        }
